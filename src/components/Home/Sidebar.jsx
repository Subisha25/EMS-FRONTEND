...
//   useEffect(() => {
//     // Example: Load role from sessionStorage (replace with your real logic)
//     const storedRole = sessionStorage.getItem('role') || 'employee';
//     setRole(storedRole);
//   }, []);
...
// import EmployeeSidebar from '../Employees/EmployeeSidebar/EmployeeSidebar';
...
export default function Sidebar() {
  const [role, setRole] = useState(null); // null to detect loading
  ...
  if (role === null) {
    return null; // show loader or empty until role is read
  }
